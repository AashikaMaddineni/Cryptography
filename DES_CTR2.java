...
class DES_CTR2 { 
   ...
   String CTR_encrypt(String X, String K, String P_I){
        	String Counter=X;
        	String C_I = null, k_I=null;
           		String Countstr = String.valueOf(Counter);
        		System.out.println("Counter "+Countstr);
        		System.out.println("\nEncryption(Key,Counter)\n"); 
        		 k_I=encrypt(Countstr, K);
        		 System.out.println("Encryption(Key,Counter): "+k_I);
        		 System.out.println("XOR(Plantext,E(Key,Counter))");
        		C_I=xor(P_I,k_I);
      			return C_I;  			      			
        }
   
   String CTR_decrypt(String X, String K, String C_I){
   	String Counter=X;
   	String P_I = null, k_I=null;
      		String Countstr = String.valueOf(Counter);
      	System.out.println("Counter "+Countstr);
  		...
  		k_I=encrypt(Countstr, K);
   		System.out.println("Encryption(Key,Counter): "+k_I);
   		System.out.println("XOR(Ciphertext,E(Key,Counter))");
   		P_I=xor(C_I,k_I);    	
	   return P_I;  			      			
   }
    ...
    { 
    	 ...
    	 System.out.println("DES CTR MODE:\n");     	
    	 String text = "8787878787878787";
    	 System.out.println("Plain text "+text);
         String key = "0E329232EA6D0D73";
         System.out.println("Key "+key);
         String Counter = "6690389392293912";
        
             DES cipher = new DES(); 
            
        String X_text = cipher.CTR_encrypt(Counter, key, text); 
        System.out.println( "\nCipher Text: " + X_text.toUpperCase()); 
        String text1 = cipher.CTR_decrypt(Counter, key, X_text); 
        System.out.println( "\nPlain Text: "+ text1.toUpperCase());
